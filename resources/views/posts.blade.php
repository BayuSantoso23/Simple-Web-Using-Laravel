<x-layout>
                ...
                <form>
                    ...
                    <div class="items-center mx-auto mt-4 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        <div class="relative w-full">
                            <label for="search" class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enter</label>
    ...
    {{-- <article class="py-4 max-w-screen-md border-b border-black">
        ...
        <div>
            ...
            <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Return</a>
        </div>
         @endforelse
        </div>  
    </div>
